          ...
          <div key={course._id.toString()} className="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div className="px-6 py-4 bg-gray-50 flex justify-between items-center">
              ...
              <div className="flex space-x-2">
                <button className="px-4 py-2 bg-blue-100 text-blue-700 rounded-md text-sm font-medium hover:bg-blue-200">
                  Edit
                </button>
                <button className="px-4 py-2 bg-red-100 text-red-700 rounded-md text-sm font-medium hover:bg-red-200">
                  Delete
                </button>
              </div>
            </div>
