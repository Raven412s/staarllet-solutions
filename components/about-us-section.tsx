    ...
    >
      <div id='about' className="w-full flex flex-col items-center justify-start border-3 border-[#101c1650] rounded-[1.2rem] py-12 px-6">
        ...
        <div className="w-full space-y-6">
          {/* Header Section */}
          <div className="lg:w-3xl w-full space-y-7 pt-6">
            <Copy><h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-[1.2] text-[#101c16] tracking-tight font-bold ">About Staarllet Staffing Solution</h1></Copy>
