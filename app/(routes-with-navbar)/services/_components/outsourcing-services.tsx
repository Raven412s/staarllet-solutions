// service/_components/outsourcing-services.tsx
'use client';
...
export default function OutsourcingServices() {
  // Get the outsourcing service data from your dataset
  const service = servicesData.services.find(service => service.slug === "outsourcing-solutions");
  
  if (!service) {
    return <div>Service not found</div>;
  }

  // Define features based on the service data
  const features = [
    {
    ...
    },
    {
      ...
      description: "Tap into a worldwide pool of skilled professionals across various domains."
    },
    {
      title: "Scalability",
    ...
    },
    {
      ...
      description: "Free up internal resources to concentrate on strategic initiatives."
    },
    {
      title: "Faster Time to Market",
      description: "Accelerate project delivery with dedicated external teams."
    },
    {
      title: "24/7 Operations",
      description: "Maintain round-the-clock productivity with teams in different time zones."
    }
  ]
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1 space-y-6">
          <Copy><Badge variant="secondary" className="text-sm font-semibold leading-relaxed">Global Talent Solutions</Badge></Copy>
          ...
          <Copy>
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              Leverage global talent to scale your business efficiently while reducing costs and accelerating growth.
            </p>
          </Copy>
          <Copy><Button size="lg" className="mt-4 leading-relaxed">Request a Consultation</Button></Copy>
        </div>
        <div className="flex-1 flex justify-center">
          <div className="relative w-full h-80 md:h-96">
            <Image
              src="/services/outsourcing.jpg"
      ...
      <section className="bg-primary py-16 text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <Copy><h2 className="text-3xl font-bold mb-4 leading-relaxed">Ready to Transform Your Business?</h2></Copy>
          <Copy>
            <p className="text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
              Get in touch with us today to discuss how our outsourcing solutions can help you achieve your business goals.
            </p>
          </Copy>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Copy><Button variant="secondary" size="lg" className="leading-relaxed">Request a Quote</Button></Copy>
            <Copy>
