// service/_components/talent-workforce-optimization.tsx
'use client';
...
export default function TalentWorkforceOptimization() {
  const service = servicesData.services.find(service => service.slug === "talent-workforce-optimization");
  ...
  const features = [
    {
      ...
      description: "Align your human capital strategy with long-term business objectives for sustainable growth."
    },
    {
      title: "Skills Gap Analysis",
      description: "Identify critical skills shortages and develop targeted strategies to address them."
    },
    {
      title: "Productivity Optimization",
      description: "Implement data-driven approaches to maximize workforce efficiency and output."
    },
    {
      title: "Cost Reduction Strategies",
      description: "Reduce operational costs while maintaining or improving workforce performance."
    },
    {
      title: "Retention Improvement",
      description: "Develop programs and strategies to improve employee retention and reduce turnover costs."
    },
    {
      title: "Change Management",
      description: "Navigate organizational transformations with minimal disruption to workforce productivity."
    }
  ]
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1 space-y-6">
          <Copy><Badge variant="secondary" className="text-sm font-semibold leading-relaxed">Strategic HR Solutions</Badge></Copy>
          ...
          <Copy>
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              Data-driven workforce strategies that align human capital with business objectives for maximum impact and efficiency.
            </p>
          </Copy>
          <Copy><Button size="lg" className="mt-4 leading-relaxed">Optimize Your Workforce</Button></Copy>
        </div>
        <div className="flex-1 flex justify-center">
          <div className="relative w-full h-80 md:h-96">
            <Image
              src="/services/workforce-optimization.jpg"
              alt="Workforce optimization strategy"
              fill
      ...
      <section className="bg-primary py-16 text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <Copy><h2 className="text-3xl font-bold mb-4 leading-relaxed">Ready to Optimize Your Workforce?</h2></Copy>
          <Copy>
            <p className="text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
              Get in touch with us today to discuss how our workforce optimization strategies can drive your business success.
            </p>
          </Copy>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Copy><Button variant="secondary" size="lg" className="leading-relaxed">Request Assessment</Button></Copy>
            <Copy>
